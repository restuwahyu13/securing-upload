...
class App {
  ...
  constructor() {
    ...
    this.pathEntitiesDir = !['production'].includes(process.env.NODE_ENV) ? 'src/entities/*.ts' : 'dist/entities/*.js'
  }
  ...
  private route(): void {
    this.app.use(`${this.version}/uploads`, Container.resolve<Router>('UploadsModule'))
  }
